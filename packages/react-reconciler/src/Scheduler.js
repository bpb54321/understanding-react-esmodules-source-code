...
import * as Scheduler from 'scheduler/src/forks/Scheduler.js';
...
// Brian edit: since this is causing eslint to emit a warning,
// replacing the undefined Scheduler properties with arrow functions.
export const log = () => {};
